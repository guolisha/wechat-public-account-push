export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxf64299913ba11b7a",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "1c89f299d88e14121146b60b605c4e72",
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "BUBAjrceTEZaIdrfM7J1Z5uikyNuQ839okzyHhQGgmw",
      // 所在省份
      province: "北京",
      // 所在城市
      city: "北京",
      ...
      festivals: [
        ...
        {"type": "*节日", "name": "一周年纪念日", "year": "2022", "date": "05-20"},
      ],
